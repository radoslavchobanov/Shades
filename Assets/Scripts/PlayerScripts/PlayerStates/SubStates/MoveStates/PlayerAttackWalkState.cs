...
public class PlayerAttackWalkState : PlayerCombatWalkState
{
    float attackDuration;

    public PlayerAttackWalkState(PlayerController playerController, PlayerStateManager stateManager, State state)
