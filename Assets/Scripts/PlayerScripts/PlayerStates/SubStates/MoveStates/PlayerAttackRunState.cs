...
public class PlayerAttackRunState : PlayerCombatRunState
{
    float attackDuration;

    public PlayerAttackRunState(PlayerController playerController, PlayerStateManager stateManager, State state)
